...
//! * Open a connection with prior knowledge, i.e. both the client and the server assume that the
//!   connection is immediately ready to start the HTTP/2 handshake once opened.
//!
...
pub use crate::h2::{
    error::{Error, Reason},
    share::{FlowControl, Ping, PingPong, Pong, RecvStream, SendStream, StreamId},
};
