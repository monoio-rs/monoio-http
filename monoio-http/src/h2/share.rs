...
///
/// * Set `end_of_stream` to true when calling [`send_request`], [`send_response`], or
///   [`send_data`].
...
///
/// * A new stream is activated. The receive window is initialized to 1024 (the value of the initial
///   window size for this connection).
...
impl<B: Buf> SendStream<B> {
    ...
    pub fn send_data(&mut self, data: B, end_of_stream: bool) -> Result<(), crate::h2::Error> {
        self.inner
...
impl RecvStream {
    ...
    pub fn poll_trailers(
        &mut self,
        cx: &mut Context,
    ) -> Poll<Result<Option<HeaderMap>, crate::h2::Error>> {
...
impl FlowControl {
    ...
    ///
    /// [struct level]: #
    pub fn release_capacity(&mut self, sz: usize) -> Result<(), crate::h2::Error> {
...
impl PingPong {
    ...
    #[doc(hidden)]
    pub fn send_ping(&mut self, ping: Ping) -> Result<(), crate::h2::Error> {
